...
{
    // Storage limits.
    dataStorage[DATASET_STG].storageLimit = 24 * 1024 * 1024; // 17MB
    dataStorage[DATASET_MUS].storageLimit = 8 * 1024 * 1024;  //  8MB
    dataStorage[DATASET_SFX].storageLimit = 32 * 1024 * 1024; // 16MB
    dataStorage[DATASET_STR].storageLimit = 2 * 1024 * 1024;  //  1MB
    dataStorage[DATASET_TMP].storageLimit = 8 * 1024 * 1024;  //  6MB
